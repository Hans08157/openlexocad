...
"""
01L_Seitenschutz_konventionell
ifcRailing
attributes
    version 1.0
        - height
...
GUID_CLASS = Base.GlobalId("{D5720420-47FC-4C74-9B7C-BFB5E97E6DB4}")
GUID_SCRPT = Base.GlobalId("{F0F45FA0-5941-4394-83B4-E02E98184FF0}")
CW_COLOR = 3101
...
class LSeitenschutz01(lx.Railing):
    _propHeader = "_01LSeitenschutzKonventionell"
    _propGroupName = "_01LSeitenschutzKonventionellProperties"
    ...
    def __init__(self, aArg):
        ...
        self.registerPythonClass("LSeitenschutz01", "OpenLxApp.Railing")

        self._insidePropUpdate = False

        self.setPropertyHeader(lxStr(LSeitenschutz01._propHeader), 514)
        self.setPropertyGroupName(lxStr(LSeitenschutz01._propGroupName), 515)

        self._width = self.registerPropertyDouble(LSeitenschutz01._widthPropName,
                                                  0.2,
                                                  lx.Property.VISIBLE,
                                                  lx.Property.EDITABLE,
                                                  502)

        self._height = self.registerPropertyDouble(LSeitenschutz01._heightPropName,
                                                   1.0,
                                                   lx.Property.VISIBLE,
                                                   lx.Property.EDITABLE,
                                                   503)
...
def main():
    ...
    if doc:
        ...
        cwColor = CW_COLOR
        element = LSeitenschutz01(doc)
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Seitenschutz konventionell"), element)
