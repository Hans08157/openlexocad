...
GUID_CLASS = Base.GlobalId("{1C57A9AC-20CC-49B8-8FC0-BCE302FB6A34}")
GUID_SCRPT = Base.GlobalId("{F889DB13-21E3-4C6D-B7BC-49400CB15C24}")
CW_COLOR = 3103
...
class LSeitenschutz(lx.Railing):
    _propHeader = "_02LSeitenschutzAbsperrlatten"
    _propGroupName = "_02LSeitenschutzAbsperrlattenProperties"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxStr(LSeitenschutz._propHeader), 518)
        self.setPropertyGroupName(lxStr(LSeitenschutz._propGroupName), 519)
...
def main():
    ...
    if doc:
        ...
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Seitenschutz Absperrlatte"), element)
        ...
        cmd.CmdSetPropertySetDefinition("Pset_RailingCommon", "reference", "02_Seitenschutz_Absperrlatte", element).redo()
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(516))  # "01_Seitenschutz_konventionell"
