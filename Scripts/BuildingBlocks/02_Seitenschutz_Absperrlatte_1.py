...
GUID_CLASS = Base.GlobalId("{9826B4F7-8D58-4289-8D27-A1BA78A67E4E}")
GUID_SCRPT = Base.GlobalId("{4C0ABED6-24D0-430B-9532-5C39E6BDBF85}")
CW_COLOR = 3102
...
class Seitenschutz02(lx.Railing):
    _propHeader = "_02SeitenschutzAbsperrlatten"
    _propGroupName = "_02SuvaAbsturzsicherungParameter"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxStr(Seitenschutz02._propHeader), 516)
        self.setPropertyGroupName(lxStr(Seitenschutz02._propGroupName), 517)

        self._width = self.registerPropertyDouble(Seitenschutz02._widthPropName,
                                                  0.2,
                                                  lx.Property.VISIBLE,
                                                  lx.Property.EDITABLE,
                                                  502)

        self._height = self.registerPropertyDouble(Seitenschutz02._heightPropName,
                                                   1.0,
                                                   lx.Property.VISIBLE,
                                                   lx.Property.EDITABLE,
                                                   503)
...
def main():
    ...
    if doc:
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(516))  # "02_Seitenschutz_Absperrlatte"
