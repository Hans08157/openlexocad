...
GUID_CLASS = Base.GlobalId("{556BBC82-0E7F-4704-9267-3B853AFCD7AA}")
GUID_SCRPT = Base.GlobalId("{AFAC2553-0DA7-4999-9BA0-D06F06F3E815}")
CW_COLOR = 3105
...
class LSeitenschutz03(lx.Railing):
    _propHeader = "_03LSeitenschutzMitAuffangnetzen"
    _propGroupName = "_03LSeitenschutzMitAuffangnetzenProperties"
    ...
    def __init__(self, aArg):
        ...
        self.registerPythonClass("LSeitenschutz03", "OpenLxApp.Railing")

        self._insidePropUpdate = False

        self.setPropertyHeader(lxStr(LSeitenschutz03._propHeader), 522)
        self.setPropertyGroupName(lxStr(LSeitenschutz03._propGroupName), 523)

        self._width = self.registerPropertyDouble(LSeitenschutz03._widthPropName,
                                                  0.2,
                                                  lx.Property.VISIBLE,
                                                  lx.Property.EDITABLE,
                                                  502)

        self._height = self.registerPropertyDouble(LSeitenschutz03._heightPropName,
                                                   1.0,
                                                   lx.Property.VISIBLE,
                                                   lx.Property.EDITABLE,
                                                   503)
