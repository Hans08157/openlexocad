...
GUID_CLASS = Base.GlobalId("{E24C8B40-0DFB-49D9-8467-EB9F468EEE3C}")
GUID_SCRPT = Base.GlobalId("{F90BFF0A-8935-4FC0-9AC8-9CADD949FE8B}")
CW_COLOR = 3104
...
class SegmentBuilder:
    ...
    def getCutBeam(self, data):
        ...
        beam.setDiffuseColor(Base.Color_fromCdwkColor(CW_COLOR))
...
class Seitenschutz03(lx.Railing):
    _propHeader = "_03SeitenschutzMitAuffangnetzen"
    _propGroupName = "_03SeitenschutzMitAuffangnetzenParameter"
    ...
    def __init__(self, aArg):
        ...
        self.registerPythonClass("Seitenschutz03", "OpenLxApp.Railing")

        self._insidePropUpdate = False

        self.setPropertyHeader(lxStr(Seitenschutz03._propHeader), 520)
        self.setPropertyGroupName(lxStr(Seitenschutz03._propGroupName), 521)

        self._width = self.registerPropertyDouble(Seitenschutz03._widthPropName,
                                                  0.2,
                                                  lx.Property.VISIBLE,
                                                  lx.Property.EDITABLE,
                                                  502)

        self._height = self.registerPropertyDouble(Seitenschutz03._heightPropName,
                                                   1.0,
                                                   lx.Property.VISIBLE,
                                                   lx.Property.EDITABLE,
                                                   503)
...
def main():
    ...
    if doc:
        ...
        cwColor = CW_COLOR
        element = Seitenschutz03(doc)
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Seitenschutz Auffangnetz"), element)
        ...
        """
        element.setPredefinedType(lx.Railing.RailingTypeEnum_USERDEFINED)

        # cmd.CmdModifyPropertySetValue("Pset_RailingCommon", "reference", Core.Variant("03_Seitenschutz_Auffangnetz"),
        #                               element).redo()
        # cmd.CmdSetPropertySetDefinition("Absturzsicherung_Suva", "Vorgespanntes_Drahtseil", True, element).redo()
        #
        # cmd.CmdSetPropertySetDefinition("Absturzsicherung_Suva", "Typ", "", element).redo()
        #
        # cmd.CmdModifyPropertySetValue("Absturzsicherung_Suva", "Typ",
        #                               Core.Variant("03_Seitenschutz_Auffangnetz"),
        #                               element).redo()
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(520))  # "03_Seitenschutz_Auffangnetz"
        ...
        cmd.CmdSetPropertySetDefinition("Pset_RailingCommon", "reference", "03_Seitenschutz_Auffangnetz", element).redo()
        ...
        cmd.CmdSetPropertySetDefinition(pset_name, prop2_name, True, element).redo()
