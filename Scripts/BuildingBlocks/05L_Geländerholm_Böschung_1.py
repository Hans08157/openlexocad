...
GUID_CLASS = Base.GlobalId("{096FCBE7-50E0-44F6-8144-24A35A000CE4}")
GUID_SCRPT = Base.GlobalId("{4AD02B72-16BA-4F15-86D2-B3A48D789C66}")
CW_COLOR = 3109
...
class LSeitenschutz(lx.Railing):
    _propHeader = "_05LGeländerholmImBereichVonBöschungen"
    _propGroupName = "_05LGeländerholmImBereichVonBöschungenProperties"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxStr(LSeitenschutz._propHeader), 528)
        self.setPropertyGroupName(lxStr(LSeitenschutz._propGroupName), 529)
...
def main():
    ...
    if doc:
        ...
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Geländerholm Böschung"), element)
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(526))  # "05_Geländerholm_Böschung"
        ...
        cmd.CmdSetPropertySetDefinition("Pset_RailingCommon", "reference", "05_Geländerholm_Böschung", element).redo()
