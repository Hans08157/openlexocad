...
GUID_CLASS = Base.GlobalId("{14AC72BE-A4C2-47EC-9393-9BF210FFCDDC}")
GUID_SCRPT = Base.GlobalId("{3CD5EDC1-1756-4823-983F-00D04C6BD2F7}")
CW_COLOR = 3108
...
class LSeitenschutz05(lx.Railing):
    _propHeader = "_05GeländerholmImBereichvonBöschungen"
    _propGroupName = "_05SuvaAbsturzsicherungParameter"
    ...
    def __init__(self, aArg):
        ...
        self.registerPythonClass("LSeitenschutz05", "OpenLxApp.Railing")

        self._insidePropUpdate = False

        self.setPropertyHeader(lxStr(LSeitenschutz05._propHeader), 526)
        self.setPropertyGroupName(lxStr(LSeitenschutz05._propGroupName), 527)

        self._width = self.registerPropertyDouble(LSeitenschutz05._widthPropName,
                                                  0.2,
                                                  lx.Property.VISIBLE,
                                                  lx.Property.EDITABLE,
                                                  502)

        self._height = self.registerPropertyDouble(LSeitenschutz05._heightPropName,
                                                   1.0,
                                                   lx.Property.VISIBLE,
                                                   lx.Property.EDITABLE,
                                                   503)
