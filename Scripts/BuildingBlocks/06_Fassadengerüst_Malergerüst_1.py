...
class Fassadengerust(lx.Wall):
    _classID = Base.GlobalId("{111C193D-45ED-4A5C-B547-0511B1E08A0A}")

    _propHeader = "_06FassadengerüstMalergerüst"
    _propGroupName = "_06FassadengerüstMalergerüstParameter"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxstr(Fassadengerust._propHeader), 530)
        self.setPropertyGroupName(lxstr(Fassadengerust._propGroupName), 531)
...
if __name__ == "__main__":
    ...
    doc.registerPythonScript(Base.GlobalId("{F32DC493-8915-4AE5-B4F0-94C1E304EBA7}"))

    try:
        cwColor = 3110
        element = Fassadengerust(doc)
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Fassadengerust Malergerust"), element)
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(530))  # "06_Fassadengerüst_Malergerüst"
        ...
        cmd.CmdSetPropertySetDefinition("Pset_WallCommon", "reference", "06_Fassadengerüst_Malergerüst", element).redo()
