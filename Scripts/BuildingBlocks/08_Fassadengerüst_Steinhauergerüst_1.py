...
class Fassadengerust(lx.Wall):
    _classID = Base.GlobalId("{A4104EA1-90D3-4E56-A1B8-3A535C6035B9}")

    _propHeader = "_08FassadengerüstSteinhauergerüst"
    _propGroupName = "_08FassadengerüstSteinhauergerüst"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxstr(Fassadengerust._propHeader), 534)
        self.setPropertyGroupName(lxstr(Fassadengerust._propGroupName), 535)
...
if __name__ == "__main__":
    ...
    doc.registerPythonScript(Base.GlobalId("{0B541DD2-A90B-476B-919A-4CA5C7FF424A}"))

    try:
        cwColor = 3112
        element = Fassadengerust(doc)
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Fassadengerüst Steinhauergerüst"), element)
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(534))  # "08_Fassadengerüst_Steinhauergerüst"
        ...
        cmd.CmdSetPropertySetDefinition("Pset_WallCommon", "reference", "08_Fassadengerüst_Steinhauergerüst", element).redo()
