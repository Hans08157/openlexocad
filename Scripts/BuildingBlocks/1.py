...
class SchachtKonusElem(lx.Element):
    _classID = "{065635d4-07c8-4a7a-af72-f2c344fe1675}"
    ...
    def _createTape(self, tapeType):
        ...
        if tapeType is 0:
            ...
            translateVector = Geom.Vec(xOffset, 0.0, coneHeight + topHeight - 0.05)
    ...
    def _createOverConePart(self):
        ...
        #  _______________
        pnt1 = Geom.Pnt(xOffset, - topRadius - thickness, coneHeight)
        pnt2 = Geom.Pnt(xOffset + topRadius + thickness, 0.0, coneHeight)
        pnt3 = Geom.Pnt(xOffset, topRadius + thickness, coneHeight)
        pnt4 = Geom.Pnt(xOffset - topRadius - thickness, 0.0, coneHeight)

        pnt5 = Geom.Pnt(xOffset, - topRadius - thickness * 0.5, coneHeight)
        pnt6 = Geom.Pnt(xOffset + topRadius + thickness * 0.5, 0.0, coneHeight)
        pnt7 = Geom.Pnt(xOffset, topRadius + thickness * 0.5, coneHeight)
        pnt8 = Geom.Pnt(xOffset - topRadius - thickness * 0.5, 0.0, coneHeight)

        pnt9 = Geom.Pnt(xOffset, - topRadius - thickness * 0.5, coneHeight + thickness * 0.5)
        pnt10 = Geom.Pnt(xOffset + topRadius + thickness * 0.5, 0.0, coneHeight + thickness * 0.5)
        pnt11 = Geom.Pnt(xOffset, topRadius + thickness * 0.5, coneHeight + thickness * 0.5)
        pnt12 = Geom.Pnt(xOffset - topRadius - thickness * 0.5, 0.0, coneHeight + thickness * 0.5)

        pnt13 = Geom.Pnt(xOffset, - topRadius, coneHeight + thickness * 0.5)
        pnt14 = Geom.Pnt(xOffset + topRadius, 0.0, coneHeight + thickness * 0.5)
        pnt15 = Geom.Pnt(xOffset, topRadius, coneHeight + thickness * 0.5)
        pnt16 = Geom.Pnt(xOffset - topRadius, 0.0, coneHeight + thickness * 0.5)

        # xOffset = bottomRadius - topRadius

        pnt17 = Geom.Pnt(xOffset, - topRadius - thickness, coneHeight + topHeight)
        pnt18 = Geom.Pnt(xOffset + topRadius + thickness, 0.0, coneHeight + topHeight)
        pnt19 = Geom.Pnt(xOffset, topRadius + thickness, coneHeight + topHeight)
        pnt20 = Geom.Pnt(xOffset - topRadius - thickness, 0.0, coneHeight + topHeight)

        # pnt21 = Geom.Pnt(xOffset, - topRadius - thickness * 0.5, coneHeight + topHeight)
        # pnt22 = Geom.Pnt(xOffset + topRadius + thickness * 0.5, 0.0, coneHeight + topHeight)
        # pnt23 = Geom.Pnt(xOffset, topRadius + thickness * 0.5, coneHeight + topHeight)
        # pnt24 = Geom.Pnt(xOffset - topRadius - thickness * 0.5, 0.0, coneHeight + topHeight)
        #
        # pnt25 = Geom.Pnt(xOffset, - topRadius - thickness * 0.5, coneHeight + topHeight - 0.05)
        # pnt26 = Geom.Pnt(xOffset + topRadius + thickness * 0.5, 0.0, coneHeight + topHeight - 0.05)
        # pnt27 = Geom.Pnt(xOffset, topRadius + thickness * 0.5, coneHeight + topHeight - 0.05)
        # pnt28 = Geom.Pnt(xOffset - topRadius - thickness * 0.5, 0.0, coneHeight + topHeight - 0.05)
        #
        # pnt29 = Geom.Pnt(xOffset, - topRadius, coneHeight + topHeight - 0.05)
        # pnt30 = Geom.Pnt(xOffset + topRadius, 0.0, coneHeight + topHeight - 0.05)
        # pnt31 = Geom.Pnt(xOffset, topRadius, coneHeight + topHeight - 0.05)
        # pnt32 = Geom.Pnt(xOffset - topRadius, 0.0, coneHeight + topHeight - 0.05)

        pnt21 = Geom.Pnt(xOffset, - 0.35, coneHeight + topHeight)
        pnt22 = Geom.Pnt(xOffset + 0.35, 0.0, coneHeight + topHeight)
        pnt23 = Geom.Pnt(xOffset, 0.35, coneHeight + topHeight)
        pnt24 = Geom.Pnt(xOffset - 0.35, 0.0, coneHeight + topHeight)

        pnt25 = Geom.Pnt(xOffset, - 0.35, coneHeight + topHeight - 0.05)
        pnt26 = Geom.Pnt(xOffset + 0.35, 0.0, coneHeight + topHeight - 0.05)
        pnt27 = Geom.Pnt(xOffset, 0.35, coneHeight + topHeight - 0.05)
        pnt28 = Geom.Pnt(xOffset - 0.35, 0.0, coneHeight + topHeight - 0.05)
    ...
    def _createCone(self):
        ...
        pnt17 = Geom.Pnt(xOffset, -topRadius - thickness, height)
        pnt18 = Geom.Pnt(xOffset + topRadius + thickness, 0.0, height)
        pnt19 = Geom.Pnt(xOffset, topRadius + thickness, height)
        pnt20 = Geom.Pnt(xOffset - topRadius - thickness, 0.0, height)

        pnt21 = Geom.Pnt(xOffset, -topRadius - thickness * 0.5, height)
        pnt22 = Geom.Pnt(xOffset + topRadius + thickness * 0.5, 0.0, height)
        pnt23 = Geom.Pnt(xOffset, topRadius + thickness * 0.5, height)
        pnt24 = Geom.Pnt(xOffset - topRadius - thickness * 0.5, 0.0, height)

        pnt25 = Geom.Pnt(xOffset, -topRadius - thickness * 0.5, height + thickness * 0.5)
        pnt26 = Geom.Pnt(xOffset + topRadius + thickness * 0.5, 0.0, height + thickness * 0.5)
        pnt27 = Geom.Pnt(xOffset, topRadius + thickness * 0.5, height + thickness * 0.5)
        pnt28 = Geom.Pnt(xOffset - topRadius - thickness * 0.5, 0.0, height + thickness * 0.5)

        pnt29 = Geom.Pnt(xOffset, -topRadius, height + thickness * 0.5)
        pnt30 = Geom.Pnt(xOffset + topRadius, 0.0, height + thickness * 0.5)
        pnt31 = Geom.Pnt(xOffset, topRadius, height + thickness * 0.5)
        pnt32 = Geom.Pnt(xOffset - topRadius, 0.0, height + thickness * 0.5)
    ...
    def _updateGeometry(self):
        ...
        with EditMode(doc):
            ...
            self._createCone()
            print("Created cone and top parts...")
            print("Creating the tape...")
    ...
    def onPropertyChanged(self, aPropertyName):
        ...
        elif aPropertyName == SchachtKonusElem._bottomDiameterPropName:
...
if __name__ == "__main__":
    ...
    doc.registerPythonScript(Base.GlobalId("{e604103b-d74d-4dca-8c63-94dd167f0bd1}"))
