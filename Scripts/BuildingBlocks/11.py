...
class LSeitenschutz(lx.Railing):
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxStr(LSeitenschutz._propHeader), 512)
        self.setPropertyGroupName(lxStr(LSeitenschutz._propGroupName), 513)
...
def main():
    ...
    if doc:
        ...
        cmd.CmdModifyPropertySetValue("Pset_RailingCommon", "reference",
                                      Core.Variant("01_Seitenschutz_konventionell"),
                                      element).redo()

        cmd.CmdSetPropertySetDefinition("Absturzsicherung_Suva", "Typ", "",
                                        element).redo()
