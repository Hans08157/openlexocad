...
GUID_CLASS = Base.GlobalId("{A15EA0F1-C779-4A32-80D3-C6352DE12AAE}")
GUID_SCRPT = Base.GlobalId("{77047157-5CB7-4720-AA30-6C16B8A8A2A9}")
CW_COLOR = 3115
...
class LSeitenschutz(lx.Railing):
    _propHeader = "_11LDachgerüstFlachdach"
    _propGroupName = "_11LDachgerüstFlachdachProperties"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxStr(LSeitenschutz._propHeader), 542)
        self.setPropertyGroupName(lxStr(LSeitenschutz._propGroupName), 543)
...
def main():
    ...
    if doc:
        ...
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Dachgerüst Flachdach"), element)
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(540))  # "11_Dachgerüst_Flachdach"
        ...
        cmd.CmdSetPropertySetDefinition("Pset_RailingCommon", "reference", "11_Dachgerüst_Flachdach", element).redo()
