...
GUID_CLASS = Base.GlobalId("{EA6C2199-4098-4C2C-BE32-139BFC66511B}")
GUID_SCRPT = Base.GlobalId("{1E51CA7B-8E20-460D-9969-B7B16A0948AB}")
CW_COLOR = 3114
...
class LSeitenschutz(lx.Railing):
    _propHeader = "_11DachgerüstFlachdach"
    _propGroupName = "_11DachgerüstFlachdachParameter"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxStr(LSeitenschutz._propHeader), 540)
        self.setPropertyGroupName(lxStr(LSeitenschutz._propGroupName), 541)
