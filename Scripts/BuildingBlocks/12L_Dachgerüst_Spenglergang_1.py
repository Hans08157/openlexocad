...
GUID_CLASS = Base.GlobalId("{B0557200-73CA-4CF9-BF42-F608A374359D}")
GUID_SCRPT = Base.GlobalId("{23E4A37B-30FB-4C72-B1FB-E212FF62C34D}")
CW_COLOR = 3117
...
class LSeitenschutz(lx.Railing):
    _propHeader = "_12LDachgerüstSpenglergang"
    _propGroupName = "_12LDachgerüstSpenglergangProperties"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxStr(LSeitenschutz._propHeader), 546)
        self.setPropertyGroupName(lxStr(LSeitenschutz._propGroupName), 547)
...
def main():
    ...
    if doc:
        ...
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Dachgerüst Spenglergang"), element)
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(544))  # "12_Dachgerüst_Spenglergang"
        ...
        cmd.CmdSetPropertySetDefinition("Pset_RailingCommon", "reference", "12_Dachgerüst_Spenglergang", element).redo()
