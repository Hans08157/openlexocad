...
GUID_CLASS = Base.GlobalId("{4408C440-97D9-4A94-A0F0-BB1596358979}")
GUID_SCRPT = Base.GlobalId("{46CF443E-2E85-48B3-A8B0-64AE2891DFFC}")
CW_COLOR = 3116
...
class LSeitenschutz(lx.Railing):
    _propHeader = "12DachgerüstSpenglergang"
    _propGroupName = "12DachgerüstSpenglergangParameter"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxStr(LSeitenschutz._propHeader), 544)
        self.setPropertyGroupName(lxStr(LSeitenschutz._propGroupName), 545)
