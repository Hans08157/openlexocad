...
GUID_CLASS = Base.GlobalId("{4B1A0736-2221-4A1A-BC86-8587634256F8}")
GUID_SCRPT = Base.GlobalId("{36B35A33-D70A-4B86-B1ED-040FE7B0090A}")
CW_COLOR = 3119
...
class LSeitenschutz(lx.Railing):
    _propHeader = "_14GiebelgerüstOhneArbeitsraum"
    _propGroupName = "_14GiebelgerüstOhneArbeitsraumParameter"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxStr(LSeitenschutz._propHeader), 550)
        self.setPropertyGroupName(lxStr(LSeitenschutz._propGroupName), 551)
...
def main():
    ...
    if doc:
        ...
        lx.setNewComponentByColorAndName(CW_COLOR, Base.StringTool.toString("Giebelgerüst ohne Arbeitsraum"), element)
