...
class Gelanderholm(lx.Wall):
    _classID = Base.GlobalId("{54569154-4C1C-4B61-A1A2-6EB8E8D0F156}")

    _propHeader = "15GiebelseiteMitArbeitsraum"
    _propGroupName = "15GiebelseiteMitArbeitsraumParameter"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxstr(Gelanderholm._propHeader), 554)
        self.setPropertyGroupName(lxstr(Gelanderholm._propGroupName), 555)
...
if __name__ == "__main__":
    ...
    doc.registerPythonScript(Base.GlobalId("{2A47B5E3-352E-4EE6-8645-4B394E7EA39E}"))

    try:
        cwColor = 3121
        element = Gelanderholm(doc)
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Giebelgerüst mit Arbeitsraum"), element)
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(554))  # "15_Giebelgerüst_mit_Arbeitsraum"
        ...
        cmd.CmdSetPropertySetDefinition("Pset_WallCommon", "reference", "15_Giebelgerüst_mit_Arbeitsraum", element).redo()
