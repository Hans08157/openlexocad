...
class Gelanderholm(lx.Wall):
    _classID = Base.GlobalId("{13CF7E66-3DFD-4975-99B4-67D63E263D83}")

    _propHeader = "_16Gerüstzugang"
    _propGroupName = "_16GerüstzugangParameter"
    ...
    def __init__(self, aArg):
        ...
        self.setPropertyHeader(lxstr(Gelanderholm._propHeader), 556)
        self.setPropertyGroupName(lxstr(Gelanderholm._propGroupName), 557)
...
if __name__ == "__main__":
    ...
    doc.registerPythonScript(Base.GlobalId("{DA39780E-563B-4E6F-AEC1-7C70E1ED3E23}"))

    try:
        cwColor = 3122
        element = Gelanderholm(doc)
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Gerustzugang"), element)
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(556))  # "16_Gerüstzugang"
        ...
        cmd.CmdSetPropertySetDefinition("Pset_WallCommon", "reference", "16_Gerüstzugang", element).redo()
