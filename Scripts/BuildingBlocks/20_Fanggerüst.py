...
class Gelanderholm(lx.Slab):
    _classID = Base.GlobalId("{52965B88-2895-4058-BFF4-766C26F42D23}")

    _propHeader = "_20Fanggerüst"
    _propGroupName = "_20FanggerüstParameter"
    ...
    def __init__(self, aArg):
        ...
        self.registerPythonClass("Gelanderholm", "OpenLxApp.Slab")

        self._insidePropUpdate = False

        self.setPropertyHeader(lxstr(Gelanderholm._propHeader), 564)
        self.setPropertyGroupName(lxstr(Gelanderholm._propGroupName), 565)
...
if __name__ == "__main__":
    ...
    doc.registerPythonScript(Base.GlobalId("{EF8C9200-FCCC-494C-B22B-FADD9861D82F}"))

    try:
        cwColor = 3126
        element = Gelanderholm(doc)
        lx.setNewComponentByColorAndName(cwColor, Base.StringTool.toString("Gelanderholm"), element)
        ...
        prop1_value = Base.StringTool.toStlString(Base.PTranslator.get(564))  # "20_Fanggerüst"
        ...
        cmd.CmdSetPropertySetDefinition("Pset_SlabCommon", "reference", "20_Fanggerüst", element).redo()
