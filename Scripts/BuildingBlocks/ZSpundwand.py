...
listOfProfiles = [
                  # AZ-800
                  ['AZ 18-800', 0.800, 0.449, 0.0085, 0.0085, 51.8],
                  ['AZ 20-800', 0.800, 0.450, 0.0095, 0.0095, 51.8],
                  ['AZ 22-800', 0.800, 0.451, 0.0105, 0.0105, 51.8],

                  ['AZ 23-800', 0.800, 0.474, 0.0115, 0.009, 52.9],
                  ['AZ 25-800', 0.800, 0.475, 0.0125, 0.010, 52.9],
                  ['AZ 27-800', 0.800, 0.476, 0.0135, 0.011, 52.9],

                  # AZ-750
                  ['AZ 28-750', 0.750, 0.509, 0.012, 0.010, 58.9],
                  ['AZ 30-750', 0.750, 0.510, 0.013, 0.011, 58.9],
                  ['AZ 32-750', 0.750, 0.511, 0.014, 0.012, 58.9],

                  # AZ-700 und AZ-770
                  ['AZ 12-770', 0.770, 0.344, 0.0085, 0.0085, 39.5],
                  ['AZ 13-770', 0.770, 0.344, 0.009, 0.009, 39.5],
                  ['AZ 14-770', 0.770, 0.345, 0.0095, 0.0095, 39.5],
                  ['AZ 15-770', 0.770, 0.345, 0.01, 0.01, 39.5],

                  ['AZ 12-700', 0.700, 0.314, 0.0085, 0.0085, 42.8],
                  ['AZ 13-700', 0.700, 0.315, 0.0095, 0.0095, 42.8],
                  ['AZ 13-700-10/10', 0.700, 0.316, 0.01, 0.01, 42.8],
                  ['AZ 14-700', 0.700, 0.316, 0.0105, 0.0105, 42.8],

                  ['AZ 17-700', 0.700, 0.420, 0.0085, 0.0085, 51.2],
                  ['AZ 18-700', 0.700, 0.420, 0.009, 0.009, 51.2],
                  ['AZ 19-700', 0.700, 0.421, 0.0095, 0.0095, 51.2],
                  ['AZ 20-700', 0.700, 0.421, 0.01, 0.01, 51.2],
                  ...
                  # AZ-700 und AZ-770
                  ['AZ 36-700N', 0.700, 0.499, 0.015, 0.0112, 63.2],
                  ['AZ 38-700N', 0.700, 0.500, 0.016, 0.0122, 63.2],
                  ['AZ 40-700N', 0.700, 0.501, 0.017, 0.0132, 63.2],

                  ['AZ 42-700N', 0.700, 0.499, 0.018, 0.014, 63.2],
                  ['AZ 44-700N', 0.700, 0.500, 0.019, 0.015, 63.2],
                  ['AZ 46-700N', 0.700, 0.501, 0.020, 0.016, 63.2],

                  ['AZ 48-700', 0.700, 0.503, 0.022, 0.015, 45.4],
                  ['AZ 50-700', 0.700, 0.504, 0.023, 0.016, 45.4],
                  ['AZ 52-700', 0.700, 0.505, 0.024, 0.017, 45.4],

                  # AZ
                  ['AZ 18 2)', 0.630, 0.380, 0.0095, 0.0095, 63.2],
                  ['AZ 18-10/10', 0.630, 0.381, 0.01, 0.01, 63.2],
                  ['AZ 26 2)', 0.630, 0.427, 0.013, 0.0122, 63.2],
...
class Spundwand(lx.Wall):
    ...
    def __init__(self, aArg):
        ...
        # Register properties
        self.setPropertyHeader(lxstr("Spundwand Z-Profile"), 259)
        self.setPropertyGroupName(lxstr("Spundwand creator"), 260)

        self._profileType = self.registerPropertyEnum(self._profileParamName, 0, lx.Property.VISIBLE,
                                                      lx.Property.EDITABLE, 261)
    ...
    def convertFromOldVersion(self, oldVersion):
        self.updatePythonProductVersion()
...
if __name__ == "__main__":
    ...
    with EditMode(doc):
        ...
        if polylineData is not None:
            comp = Spundwand(doc)
            lx.setNewComponentByColorAndName(CW_COLOR, Base.StringTool.toString("alpha_beton_pilze_oval"), comp)
