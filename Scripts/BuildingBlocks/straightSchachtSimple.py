...
class StraightSchachtElemSimplified(lx.Element):
    _classID = "{E37E6203-D4D3-4473-A1F5-F15E917078B3}"
    _headerPropName = "Straight Schacht"
    _groupPropName =  "Straight Schacht Parameter"
    ...
    def getGlobalClassId(self):
        return Base.GlobalId(StraightSchachtElemSimplified._classID)

    def __init__(self, aArg):
        lx.Element.__init__(self, aArg)
        self.registerPythonClass("StraightSchachtElemSimplified", "OpenLxApp.Element")
        # Register properties
        self.setPropertyHeader(lxstr(StraightSchachtElemSimplified._headerPropName), -1)
        self.setPropertyGroupName(lxstr(StraightSchachtElemSimplified._groupPropName), -1)

        self._diameterUpper = self.registerPropertyDouble(StraightSchachtElemSimplified._diameterUpperPropName,
                                                          0.625,
                                                          lx.Property.VISIBLE,
                                                          lx.Property.EDITABLE, -1)
        self._diameterLower = self.registerPropertyDouble(StraightSchachtElemSimplified._diameterLowerPropName,
                                                          1.0,
                                                          lx.Property.VISIBLE,
                                                          lx.Property.EDITABLE, -1)
        self._topHeight = self.registerPropertyDouble(StraightSchachtElemSimplified._topHeightPropName,
                                                      0.3,
                                                      lx.Property.VISIBLE,
                                                      lx.Property.EDITABLE, -1)
        self._middleHeight = self.registerPropertyDouble(StraightSchachtElemSimplified._middleHeightPropName,
                                                         0.6,
                                                         lx.Property.VISIBLE,
                                                         lx.Property.EDITABLE, -1)
        self._lowerHeight = self.registerPropertyDouble(StraightSchachtElemSimplified._lowerHeightPropName,
                                                        1.0,
                                                        lx.Property.VISIBLE,
                                                        lx.Property.EDITABLE, -1)
    ...
    def _createUpperPart(self):
        ...
        if height <= 0:
            ...
            translateVector = Geom.Vec(0.0, 0.0, zOffset)
    ...
    def _createCone(self):
        ...
        pnt5 = Geom.Pnt(0.0, -topRadius, height)
        pnt6 = Geom.Pnt(topRadius, 0.0, height)
        pnt7 = Geom.Pnt(0.0, topRadius, height)
        pnt8 = Geom.Pnt(-topRadius, 0.0, height)
    ...
    def onPropertyChanged(self, aPropertyName):
        if aPropertyName == StraightSchachtElemSimplified._diameterLowerPropName:
            self.setLowerDiameter(self._diameterLower.getValue())
        elif aPropertyName == StraightSchachtElemSimplified._diameterUpperPropName:
            self.setUpperDiameter(self._diameterUpper.getValue())
        elif aPropertyName == StraightSchachtElemSimplified._topHeightPropName:
            self.setTopHeight(self._topHeight.getValue())
        elif aPropertyName == StraightSchachtElemSimplified._middleHeightPropName:
            self.setMiddleHeight(self._middleHeight.getValue())
        elif aPropertyName == StraightSchachtElemSimplified._lowerHeightPropName:
            self.setLowerHeight(self._lowerHeight.getValue())


if __name__ == "__main__":
    # Register this Python Script
    doc.registerPythonScript(Base.GlobalId("{5FE004A7-1E4B-4347-B64F-C7CC79F2838B}"))

    try:
        compound = StraightSchachtElemSimplified(doc)
