...
# 3. Create profile  
#----------------------------------------------------------------------------------------
profile = lx.RectangleHollowProfileDef.createIn(doc)
profile.setXDim(2)
profile.setYDim(2)
profile.setInnerFilletRadius(.1)
profile.setOuterFilletRadius(.2)
profile.setWallThickness(.1)
