...
class LX_BASE_EXPORT StopWatch
{
public:
    StopWatch();
    ~StopWatch();
...
struct LX_BASE_EXPORT Tools
{
     ...
     */
    static inline QString fromStdString(const std::string & s) { return QString::fromUtf8(s.c_str(), (int)s.size()); }
};
