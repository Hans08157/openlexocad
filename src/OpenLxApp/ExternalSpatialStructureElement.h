...
FORWARD_DECL(App, ExternalSpatialStructureElement)
...
{
/**
 * @brief The external spatial structure element is an abstract entity provided for different kind of external spaces, regions, and volumes.
 *
 * @see <a href="http://standards.buildingsmart.org/IFC/RELEASE/IFC4/ADD2_TC1/HTML/link/ifcexternalspatialstructureelement.htm"
 * target="_blank">Documentation from IFC4: IfcExternalSpatialStructureElement</a>
 * @ingroup OPENLX_SPATIALELEMENTS
 */
class LX_OPENLXAPP_EXPORT ExternalSpatialStructureElement : public SpatialElement
{
    PROXY_HEADER_ABSTRACT(ExternalSpatialStructureElement, App::ExternalSpatialStructureElement, IFCEXTERNALSPATIALSTRUCTUREELEMENT)

public:
    virtual ~ExternalSpatialStructureElement(void);
