 ...
 */
class LX_BASE_EXPORT ViewProjMethod
{
public:
 ...
 */
class LX_BASE_EXPORT ViewProjMatrix : public ViewProjMethod
{
public:
 ...
 */
class LX_BASE_EXPORT ViewOrthoProjMatrix : public ViewProjMethod
{
public:
